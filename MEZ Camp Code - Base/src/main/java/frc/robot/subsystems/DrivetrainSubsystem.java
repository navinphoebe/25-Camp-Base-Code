...
import frc.robot.util.drivetrain.MAXSwerveModule;
import frc.robot.util.drivetrain.SwerveModule;
import frc.robot.util.drivetrain.SwerveModuleSim;
import frc.robot.util.simulation.CoralVisualizer;
import edu.wpi.first.wpilibj2.command.SubsystemBase;
import frc.robot.util.drivetrain.ADIS;
import frc.robot.util.drivetrain.GyroSim;
import frc.robot.util.drivetrain.Gyro;

public class DrivetrainSubsystem extends SubsystemBase {
  // Create MAXSwerveModuless
  private SwerveModule m_frontLeft = new MAXSwerveModule(
      DriveConstants.kFrontLeftDrivingCanId,
      DriveConstants.kFrontLeftTurningCanId,
      DriveConstants.kFrontLeftChassisAngularOffset);

  private SwerveModule m_frontRight = new MAXSwerveModule(
      DriveConstants.kFrontRightDrivingCanId,
      DriveConstants.kFrontRightTurningCanId,
      DriveConstants.kFrontRightChassisAngularOffset);

  private SwerveModule m_rearLeft = new MAXSwerveModule(
      DriveConstants.kRearLeftDrivingCanId,
      DriveConstants.kRearLeftTurningCanId,
      DriveConstants.kBackLeftChassisAngularOffset);

  private SwerveModule m_rearRight = new MAXSwerveModule(
      DriveConstants.kRearRightDrivingCanId,
      DriveConstants.kRearRightTurningCanId,
      DriveConstants.kBackRightChassisAngularOffset);

  // The gyro sensor
  private Gyro m_gyro = new ADIS();
  ...
  public static final double DRIVETRAIN_TRACKWIDTH_METERS = Units.inchesToMeters(19.75); // Roughly accurate
  ...
  public DrivetrainSubsystem() {
    if (Robot.isSimulation()) {
      ...
      m_rearLeft = new SwerveModuleSim();
      m_rearRight = new SwerveModuleSim();
  ...
  public void periodic() {
    ...
    // Update the Coral Visualizer
    CoralVisualizer.showHeldNotes();
    m_poseEstimator.update(getPose().getRotation(), getSwerveModulePositions());
  }
